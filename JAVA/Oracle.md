...
##### - 'YEAR'가 제시되면 달을 기준으로 반올림하며, 7월부터 반올림 되어 다음 년도로 표시된다.
...
|함수|목적|
|:---:|:---|
|TO_CHAR 함수|숫자 또는 날짜 형식의 데이터를 문자 형식으로 변환|
|TO_NUMBER 함수|문자 형식의 데이터를 숫자 형식으로 변환|
|TO_DATE 함수|문자 형식의 데이터를 날짜 형식으로 변환|

## TO_CHAR
##### 숫자 또는 날짜 형식의 데이터를 문자 형식으로 나타낸다.
